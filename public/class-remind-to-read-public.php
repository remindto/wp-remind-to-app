...
<<<<<<< HEAD
	...
	public function show_continue_reading() {
		return isset($_GET['continue']) ? true : false;
	}
	
	public function show_remind_to_read() {
		$rtrsettings = $this->rtr_ext_settings();
		return isset($_GET['remind']) ? $_GET['remind'] : ($rtrsettings["remind_to_read_active"] == 'yes') ? true : false;
	}

	public function remind_to_read_module_insert() {
		if( $this->show_remind_to_read() ){
			require 'partials/remind-to-read-public-display.php';
		}
