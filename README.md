...
* A `remind-to-read` directory that contains the source code - a fully executable WordPress plugin.
...
* `remind-to-read/includes` is where functionality shared between the admin area and the public-facing parts of the site reside
* `remind-to-read/admin` is for all admin-specific functionality
* `remind-to-read/public` is for all public-facing functionality
